...
if (amysBirthYear === brittanisBirthYear) {
  console.log("Amy and brittani born in the same year")
} else {
...
else if (temperature >= 61 && temperature <= 79 && rain) {
  console.log("wear rainjacket")
}
else {
...
//Once you have logged the countdown, make sure you decrement z by 1. If your code is running properly, you 
//should see: 5,4,3,2,1,4,3,2,1,3,2,1,2,1,1.

while (z > 0) {
  for (let countdown = z; countdown >= 1; countdown--) {
